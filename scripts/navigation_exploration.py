...
# activities 0 - 2
waypoints = [[[35.2, 17.4], [35.2, 14.4], [35.2, 12.5]],
             [[30.9, 16.6], [30.5, 14.3], [31.3, 12.4]],
             [[26.9, 16.6], [25.3, 14.1], [27.2, 12.0]],
             [[26.3, 19.9]]]
...
if __name__ == '__main__':
    ...
    for areas in waypoints:
        for wp in areas:
            rospy.loginfo("send goal")
            goal_pose = MoveBaseGoal()
            goal_pose.target_pose.header.frame_id = "map"
            goal_pose.target_pose.header.stamp = rospy.Time.now()
            goal_pose.target_pose.pose.position.x = wp[0]
            goal_pose.target_pose.pose.position.y = wp[1]
        ...
        exp.mode = 1
        trigger_client.send_goal(exp)
        trigger_client.wait_for_result()
